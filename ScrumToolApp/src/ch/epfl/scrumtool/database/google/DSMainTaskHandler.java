 ...
 *
 */
public class DSMainTaskHandler extends DoubleEntityDatabaseHandler<MainTask, Issue> {
	...
	public void insert(MainTask object) {
		...
		try {
			scrumMainTask.setLastModUser(Session.getCurrentSession().getUser().getEmail());
    ...
    private class GetMainTaskTask extends AsyncTask<String, Void, ScrumMainTask> {
        ...
        protected void onPostExecute(ScrumMainTask sm) {
            ...
            mB.setId(0000); // TODO change this value
            mB.setName(sm.getName());
            mB.setDescription(sm.getDescription());
            mB.setStatus(ch.epfl.scrumtool.entity.Status.READY_FOR_SPRINT); //TODO change this value
